...
public:
	...
	declare static function invertY(inFile as string, outFile as string) as boolean
...
private:
	...
	declare static function parseDoubleArray(value as string, toArr() as double, delim as string = " ") as integer
